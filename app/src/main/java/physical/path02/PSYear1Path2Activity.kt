...
class PSYear1Path2Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_psyear1path2)
        ...
        var nextYear = findViewById<Button>(R.id.btn_NextYear)
       ...
       // addResult(result1)
        ...
        nextYear.setOnClickListener {
            val intent = Intent(this , PSYear2Path2Activity::class.java)
